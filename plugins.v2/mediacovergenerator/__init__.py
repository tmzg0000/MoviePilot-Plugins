...
from app.plugins.mediacovergenerator.style_multi_2 import create_style_multi_2
...
# 假设你也有一个 multi_2 的预览图，如果没有，可以暂时复用 multi_1 或者留空
# from app.plugins.mediacovergenerator.static.multi_2  import multi_2
...
class MediaCoverGenerator(_PluginBase):
    ...
    def get_form(self) -> Tuple[List[dict], Dict[str, Any]]:
                    ...
                    },
                    {
                        ...
                        'content': [
                            {'component': 'VAceEditor',
                             'props': {'modelvalue': 'title_config', 'lang': 'yaml', 'theme': 'monokai',
                                       'style': 'height: 30rem', 'label': '中英标题配置',
                                       'placeholder': '''媒体库名称:\n- 中文标题\n- 英文标题'''}}
                        ]
                    }
                ]
                ...
                'content': [
                    {
                        ...
                        'content': [
                            {'component': 'VAlert', 'props': {'type': 'info', 'variant': 'tonal',
                                                              'text': '自定义图片目录：请将图片存于与媒体库同名的子目录下。多图模式下，文件名须为 1.jpg, 2.jpg...9.jpg'}}
                        ]
                    },
                    {
                        'component': 'VCol',
                        ...
                        'content': [
                            {'component': 'VTextField',
                             'props': {'model': 'covers_input', 'label': '自定义图片目录（可选）',
                                       'prependInnerIcon': 'mdi-file-image', 'hint': '使用目录内图片生成封面',
                                       'persistentHint': True}}
                        ]
                    },
                    {
                        ...
                        'content': [
                            {'component': 'VTextField',
                             'props': {'model': 'covers_output', 'label': '封面另存目录（可选）',
                                       'prependInnerIcon': 'mdi-file-image', 'hint': '生成的封面在此另存一份',
                                       'persistentHint': True}}
                        ]
                    }
                ]
                ...
                'content': [
                    ...
                    },
                    {
                        ...
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'zh_font_path_local', 'label': '中文字体（本地路径）',
                                               'prependInnerIcon': 'mdi-ideogram-cjk',
                                               'placeholder': '留空使用预设字体', 'hint': '字体本地路径，优先使用',
                                               'persistentHint': True}}]
                    },
                    {
                        'component': 'VCol',
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'en_font_path_local', 'label': '英文字体（本地路径）',
                                               'prependInnerIcon': 'mdi-format-font', 'placeholder': '留空使用预设字体',
                                               'hint': '字体本地路径，优先使用', 'persistentHint': True}}]
                    },
                    {
                        'component': 'VCol',
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'zh_font_url', 'label': '中文字体（下载链接）',
                                               'prependInnerIcon': 'mdi-link', 'placeholder': '留空使用预设字体',
                                               'hint': '下载链接，优先级低于本地路径', 'persistentHint': True}}]
                    },
                    {
                        'component': 'VCol',
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'en_font_url', 'label': '英文字体（下载链接）',
                                               'prependInnerIcon': 'mdi-link', 'placeholder': '留空使用预设字体',
                                               'hint': '下载链接，优先级低于本地路径', 'persistentHint': True}}]
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'zh_font_size', 'label': '中文字体大小比例',
                                               'prependInnerIcon': 'mdi-format-size', 'placeholder': '留空使用预设尺寸',
                    ...
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'en_font_size', 'label': '英文字体大小比例',
                                               'prependInnerIcon': 'mdi-format-size', 'placeholder': '留空使用预设尺寸',
                                               'hint': '根据自己喜好设置，值为相对原本尺寸的比例，1为原本大小',
                                               'persistentHint': True}}]
                    },
                    {
                        'component': 'VCol',
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField', 'props': {'model': 'blur_size', 'label': '背景模糊尺寸',
                    ...
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'color_ratio', 'label': '背景颜色混合占比',
                                               'prependInnerIcon': 'mdi-format-color-fill',
                                               'placeholder': '留空使用预设占比', 'hint': '颜色所占的比例，0-1，默认 0.8',
                                               'persistentHint': True}}]
                    },
                    {
                        'component': 'VCol',
                        ...
                        'content': [{'component': 'VSwitch',
                                     'props': {'model': 'single_use_primary', 'label': '优先使用海报图',
        ...
        styles = [
            ...
            # 新增多图2的选项
            {"title": "多图 2", "value": "multi_2", "src": multi_1}  # 暂时复用 multi_1 的图片作为预览
        ]
                    ...
                    'content': [
                        {
                            ...
                            "content": [
                                {"component": "VImg",
                                 "props": {"src": style.get("src"), "aspect-ratio": "16/9", "cover": True}},
                                {
                                    "component": "VCardTitle",
                                    "props": {"class": "text-secondary text-h6 text-center bg-surface-light"},
                                    "content": [{"component": "VRadio",
                                                 "props": {"color": "primary", "value": style.get("value"),
        ...
        style_tab = [
            {
                ...
                'props': {'model': 'cover_style', 'inline': True},
        ...
        multi_1_tab = [
            {
                ...
                'content': [
                    ...
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'zh_font_path_multi_1_local', 'label': '中文字体（本地路径）',
                                               'prependInnerIcon': 'mdi-ideogram-cjk',
                                               'placeholder': '留空使用预设字体',
                                               'hint': '字体本地路径，优先使用，多图风格专用', 'persistentHint': True}}]
                    },
                    {
                        'component': 'VCol',
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'en_font_path_multi_1_local', 'label': '英文字体（本地路径）',
                                               'prependInnerIcon': 'mdi-format-font', 'placeholder': '留空使用预设字体',
                                               'hint': '字体本地路径，优先使用，多图风格专用', 'persistentHint': True}}]
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'zh_font_url_multi_1', 'label': '中文字体（下载链接）',
                                               'prependInnerIcon': 'mdi-link', 'placeholder': '留空使用预设字体',
                    ...
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'en_font_url_multi_1', 'label': '英文字体（下载链接）',
                                               'prependInnerIcon': 'mdi-link', 'placeholder': '留空使用预设字体',
                                               'hint': '下载链接，优先级低于本地路径，多图风格专用',
                                               'persistentHint': True}}]
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'zh_font_size_multi_1', 'label': '中文字体大小比例',
                                               'prependInnerIcon': 'mdi-format-size', 'placeholder': '留空使用预设尺寸',
                                               'hint': '根据自己喜好设置，值为相对原本尺寸的比例，1为原本大小',
                                               'persistentHint': True}}]
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'en_font_size_multi_1', 'label': '英文字体大小比例',
                                               'prependInnerIcon': 'mdi-format-size', 'placeholder': '留空使用预设尺寸',
                                               'hint': '根据自己喜好设置，值为相对原本尺寸的比例，1为原本大小',
                                               'persistentHint': True}}]
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'blur_size_multi_1', 'label': '背景模糊尺寸',
                                               'prependInnerIcon': 'mdi-blur', 'placeholder': '留空使用预设尺寸',
                    ...
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 6},
                        'content': [{'component': 'VTextField',
                                     'props': {'model': 'color_ratio_multi_1', 'label': '背景颜色混合占比',
                                               'prependInnerIcon': 'mdi-format-color-fill',
                ...
                'content': [
                    {
                        'component': 'VCol',
                        'props': {'cols': 12, 'md': 3},
                        'content': [{'component': 'VSwitch', 'props': {'model': 'multi_1_blur', 'label': '启用模糊背景',
                                                                       'hint': '不启用则使用纯色渐变背景',
                                                                       "persistent-hint": True}}]
                    },
                    {
                        ...
                        'props': {'cols': 12, 'md': 3},
                        'content': [{'component': 'VSwitch',
                                     'props': {'model': 'multi_1_use_main_font', 'label': '使用单图风格字体',
                                               'hint': '勾选则忽略本页字体设置，字体大小除外', "persistent-hint": True}}]
                    },
                    {
                        'component': 'VCol',
                        'props': {'cols': 12, 'md': 3},
                        'content': [{'component': 'VSwitch',
                                     'props': {'model': 'multi_1_use_primary', 'label': '优先使用海报图',
                                            ...
                                            {'component': 'VCol', 'props': {'cols': 12, 'md': 3}, 'content': [
                                                {'component': 'VSwitch',
                                                 'props': {'model': 'onlyonce', 'label': '立即运行一次',
                                                           'hint': '更新全部媒体库封面', 'persistentHint': True}}]},
                                            {'component': 'VCol', 'props': {'cols': 12, 'md': 3}, 'content': [
                                                {'component': 'VSwitch',
                                                 'props': {'model': 'transfer_monitor', 'label': '入库监控',
                                                           'hint': '自动更新入库媒体所在媒体库封面',
                                                           'persistentHint': True}}]},
                                            {'component': 'VCol', 'props': {'cols': 12, 'md': 3}, 'content': [
                                                {'component': 'VTextField',
                                                 'props': {'model': 'delay', 'label': '入库延迟（秒）',
                                                           'placeholder': '60', 'hint': '根据实际情况调整延迟时间',
                                                           'persistentHint': True}}]},
                                        ]
                                    },
                                    {
                                        ...
                                        'content': [
                                            {
                                                ...
                                                'content': [{'component': 'VSelect',
                                                             'props': {'multiple': True, 'chips': True,
                                                                       'clearable': True, 'model': 'selected_servers',
                                                                       'label': '媒体服务器', 'items': [
                                                                     {"title": config.name, "value": config.name} for
                                                                     config in
                                                                     self.mediaserver_helper.get_configs().values() if
                                                                     config.type in ("emby", "jellyfin")]}}]
                                            },
                                            {
                                                'component': 'VCol',
                                                'props': {'cols': 12, 'md': 3},
                                                'content': [{'component': 'VSelect',
                                                             'props': {'chips': True, 'multiple': False,
                                                                       'model': 'sort_by',
                                                                       'label': '封面来源排序，默认随机',
                                                                       'items': [{"title": "随机", "value": "Random"},
                                                                                 {"title": "最新入库",
                                                                                  "value": "DateCreated"},
                                                                                 {"title": "最新发行",
                                                                                  "value": "PremiereDate"}]}}]
                                        ...
                                        'content': [
                                            {
                                                ...
                                                'content': [{'component': 'VSelect',
                                                             'props': {'multiple': True, 'chips': True,
                                                                       'clearable': True, 'model': 'exclude_libraries',
                                                                       'label': '忽略媒体库，默认更新全部', 'items': [
                ...
                "content": [
                    {
                        ...
                        "content": [
                            {"component": "VTab", "props": {"value": "style-tab"}, "content": [{"component": "VIcon",
                                                                                                "props": {
                                                                                               ...
                                                                                               {"component": "span",
                                                                                                "text": "封面风格"}]},
                            {"component": "VTab", "props": {"value": "title-tab"}, "content": [{"component": "VIcon",
                                                                                                "props": {
                                                                                               ...
                                                                                               {"component": "span",
                                                                                                "text": "封面标题"}]},
                            {"component": "VTab", "props": {"value": "single-tab"}, "content": [{"component": "VIcon",
                                                                                                 "props": {
                                                                                                ...
                                                                                                {"component": "span",
                                                                                                 "text": "单图风格设置"}]},
                            {"component": "VTab", "props": {"value": "multi-1-tab"}, "content": [{"component": "VIcon",
                                                                                                  "props": {
                                                                                                      "icon": "mdi-palette-swatch-variant",
                                                                                                      "start": True,
                                                                                                      "color": "#609585"}},
                                                                                                 {"component": "span",
                                                                                                  "text": "多图风格1设置"}]},
                            {"component": "VTab", "props": {"value": "others-tab"}, "content": [{"component": "VIcon",
                                                                                                 "props": {
                                                                                                     "icon": "mdi-cogs",
                                                                                                     "start": True,
                                                                                                     "color": "#8958f4"}},
                    ...
                    {"component": "VDivider"},
                    {
                        ...
                        "props": {"model": "tab"},
                        "content": [
                            {"component": "VWindowItem", "props": {"value": "title-tab"},
                             "content": [{"component": "VCardText", "content": title_tab}]},
                            {"component": "VWindowItem", "props": {"value": "others-tab"},
                             "content": [{"component": "VCardText", "content": others_tab}]},
                            {"component": "VWindowItem", "props": {"value": "style-tab"},
                             "content": [{"component": "VCardText", "content": style_tab}]},
                            {"component": "VWindowItem", "props": {"value": "single-tab"},
                             "content": [{"component": "VCardText", "content": single_tab}]},
                            {"component": "VWindowItem", "props": {"value": "multi-1-tab"},
                             "content": [{"component": "VCardText", "content": multi_1_tab}]},
                        ],
                    },
                ],
            }
...
''',
    ...
    def __update_all_libraries(self):
        ...
        for server, service in self._servers.items():
            ...
            cover_style = {
                ...
                "single_2": "单图 2",
                "multi_1": "多图 1",
                "multi_2": "多图 2"  # 添加 multi_2 的日志说明
            }.get(self._cover_style, self._cover_style)
    ...
    def __generate_image_from_path(self, server, library_name, title, image_path=None):
        ...
        # 添加 Multi 2 的处理逻辑
        elif self._cover_style == 'multi_2':
            # 复用 multi_1 的字体设置，或者你可以创建新的配置项
            zh_font_path = self._zh_font_path if self._multi_1_use_main_font else self._zh_font_path_multi_1
            en_font_path = self._en_font_path if self._multi_1_use_main_font else self._en_font_path_multi_1
            font_path = (zh_font_path, en_font_path)
            # 复用多图1的字体大小设置
            ...
            # 准备图片逻辑与 multi_1 相同
            if self.prepare_library_images(library_dir):
                image_data = create_style_multi_2(library_dir, title, font_path, font_size=font_size)

        return image_data

    def __generate_from_server(self, service, library, title):
        logger.info(f"媒体库 {service.name}：{library['Name']} 开始筛选媒体项")
        required_items = 1 if self._cover_style.startswith('single') else 16
        items = []
        offset = 0
        batch_size = 20
        max_attempts = 5
        ...
        if len(items) > 0:
            if self._cover_style.startswith('single'):
                ...
                # multi 1 和 multi 2 都走这里，都是取前9张
                return self.__update_grid_image(service, library, title, items[:16])
        else:
    ...
    def __handle_boxset_library(self, service, library, title):
        ...
        if service.type == 'emby':
            ...
            library_id = library.get("ItemId")
        parent_id = library_id
        boxsets = self.__get_items_batch(service, parent_id, include_types=include_types)
        ...
        if len(valid_items) > 0:
            if self._cover_style.startswith('single'):
                ...
                return self.__update_grid_image(service, library, title, valid_items[:16])
        else:
            print(f"媒体库 {service.name}：{library['Name']} 无法找到有效的图片项目")
            return False
    ...
    def __handle_playlist_library(self, service, library, title):
        ...
        if service.type == 'emby':
            ...
            library_id = library.get("ItemId")
        parent_id = library_id
        playlists = self.__get_items_batch(service, parent_id, include_types=include_types)
        required_items = 1 if self._cover_style.startswith('single') else 9
        valid_items = []
        ...
        if len(valid_items) < required_items:
            for playlist in playlists:
                if len(valid_items) >= required_items:
                    break
                movies = self.__get_items_batch(service, parent_id=playlist['Id'], include_types=include_types)
                valid_movies = self.__filter_valid_items(movies)
                valid_items.extend(valid_movies)
                if len(valid_items) >= required_items:
                    break
    ...
    def __filter_valid_items(self, items):
        ...
        for item in items:
            ...
            if item['Type'] in 'MusicAlbum,Audio':
                if item.get("ParentBackdropImageTags") or item.get("AlbumPrimaryImageTag") or item.get(
                        "PrimaryImageTag"):
    ...
    def prepare_library_images(self, library_dir: str):
        ...
        if len(source_image_paths) < len(missing_numbers):
            logger.info(
                f"信息: 源图片数量({len(source_image_paths)})小于缺失数量({len(missing_numbers)})，某些图片将被重复使用。")
    ...
    def __get_fonts(self):
        ...
        # 将 multi_1 和 multi_2 视为同一类使用专用字体的风格
        is_multi_style = self._cover_style in ["multi_1", "multi_2"]

        if is_multi_style and not self._multi_1_use_main_font:
            log_prefix = "多图风格"
                ...
                if url_has_changed or not font_file_is_valid:
                    ...
                    if self.download_font_safely(url, downloaded_font_file_path):
                        ...
                        if font_file_is_valid:
                            logger.warning(
                                f"下载失败，但找到一个已存在的（可能旧版本）有效字体文件 {downloaded_font_file_path}，将尝试使用。")
                            current_font_path = downloaded_font_file_path
                        else:
                            current_font_path = None
                else:
